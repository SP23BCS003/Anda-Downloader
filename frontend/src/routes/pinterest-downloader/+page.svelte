<script lang="ts">
  ...
  let pageTitle = 'Pinterest <span class="text-red-700">Video Downloader</span>';
  let pageSubtitle = 'Save Pinterest videos, ideas, and pins quickly.';
...
<div class="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200">
  ...
  <InfoSection title="How to Download Pinterest Videos?" platformName="Pinterest Downloader" />
  <Footer />
</div>
