<script lang="ts">
  ...
  let pageTitle = 'CapCut <span class="text-black">Template Downloader</span>';
  let pageSubtitle = 'Download CapCut templates and videos without watermark.';
...
<div class="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200">
  ...
  <InfoSection title="How to Download CapCut Templates?" platformName="CapCut Downloader" />
  <Footer />
</div>
