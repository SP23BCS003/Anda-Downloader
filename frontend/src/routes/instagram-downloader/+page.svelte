<script lang="ts">
  ...
  $: seo = (data.seo && data.seo['instagram-downloader']) || {};
  $: pageTitle = seo.title || 'Instagram <span class="text-red-600">Reels Downloader</span>';
  $: pageSubtitle = seo.description || 'Save Instagram Reels, Stories, and Videos easily.';
...
<SEOHead pageId="instagram-downloader" seoData={data.seo} />
...
<div class="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200">
  ...
  <InfoSection title="How to Download Instagram Reels?" platformName="Instagram Downloader" />
